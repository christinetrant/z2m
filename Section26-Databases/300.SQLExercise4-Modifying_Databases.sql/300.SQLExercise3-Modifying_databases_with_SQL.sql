/* Changing row with UPDATE and DELETE */
CREATE TABLE users (
...
/* IF you want to add a new column to an already existing table and instead of NULL for existing entries it will say "uknown" */
...
-- EXERCISES
-- CHALLENGE: DYNAMIC DOCUMENTS (UPDATE and DELETE)
...
UPDATE documents SET author = 
'Jackie Draper' WHERE author = 
'Jackie Paper';
...
-- CHALLENGE: CLOTHING ALTERATIONS (ALTER)
...
INSERT INTO clothes (type, design, price) VALUES ("shoes", "stiletto", 50);
